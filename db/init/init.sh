...
$CMD_MYSQL -e "create table ${MYSQL_ROOMS_TABLE} (
    ${MYSQL_ROOMS_TABLE_ID} varchar(255) NOT NULL,
    ${MYSQL_ROOMS_TABLE_NAME} varchar(32) NOT NULL,
    ${MYSQL_ROOMS_TABLE_DESCRIPTION} varchar(255) NOT NULL,
    ${MYSQL_ROOMS_TABLE_PASSWORD} varchar(32) NOT NULL,
    ${MYSQL_ROOMS_TABLE_COOKIE_NAME} varchar(255) NOT NULL,
    ${MYSQL_ROOMS_TABLE_COOKIE_VALUE} varchar(255) NOT NULL,
...
#GESTUSER
$CMD_MYSQL -e "create table ${MYSQL_GEST_USERS_TABLE} (
    ${MYSQL_GEST_USERS_TABLE_ID} int(16)  AUTO_INCREMENT,
    ${MYSQL_GEST_USERS_TABLE_NAME} varchar(32) NOT NULL,
    ${MYSQL_GEST_USERS_TABLE_TEXT} varchar(2048) NOT NULL,
    ${MYSQL_ROOMS_TABLE_ID} varchar(255)  NOT NULL,
    ${MYSQL_GEST_USERS_TABLE_CREATEDAT} DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ${MYSQL_GEST_USERS_TABLE_UPDATEDAT} DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (${MYSQL_GEST_USERS_TABLE_ID})
);"